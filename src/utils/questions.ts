export const questions = {
  ...
  targetTraits: [
    ...
    { id: "mood", text: "How are they feeling?", prompt: "This is the target person's current emotional state", temperature: 0.5, examples: "Sad, Happy, Confused" },
    { id: "origin", text: "Where are they from?", prompt: "This is the target person's origin/nationality", temperature: 0.5, examples: "America, England, Japan" },
    { id: "loves", text: "What do they love?", prompt: "These are the target person's interests and likes", temperature: 0.5, examples: "Mythology, Traveling, Music" },
    { id: "dislikes", text: "What do they dislike?", prompt: "These are things the target person dislikes - avoid these topics", temperature: 0.5, examples: "Spicy food, Loud noises, Crowds" },
  ...
  generalInfo: [
    { id: "situation", text: "What's the situation?", prompt: "This describes the context/scenario of the interaction", temperature: 0.5, examples: "Date, Party, Online Texting" },
    { id: "previousTopics", text: "What topics have you chatted about before?", prompt: "These are topics already discussed with the target person", temperature: 0.8, examples: "Books, Movies, Food" }
  ]
};