export const questions = {
  ...
  targetTraits: [
    ...
    { id: "targetGender", text: "What's their gender?", prompt: "Consider gender", priority: 0.3 },
    ...
    { id: "hobbies", text: "What are their hobbies?", prompt: "Use interests as conversation starters", priority: 0.6 },
    ...
    { id: "humor", text: "How is their sense of humor?", prompt: "Match their humor style", priority: 0.6 },
  ...
  generalInfo: [
    { id: "situation", text: "What's the situation?", prompt: "Try to match your responses according to the situation", priority: 0.6 },
    { id: "previousTopics", text: "What topics have you chatted about before?", prompt: "Build on previous conversations", priority: 0.3 }
  ],
};